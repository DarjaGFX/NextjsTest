  ...
  return (
    <div className="flex flex-col items-center justify-center h-72 w-64  mt-20 mr-20 p-3 rounded-xl bg-sky-100">
        ...
        <div className="w-full py-2 flex flex-col justify-between">
            <Button className="w-full rounded-lg" variant="contained" onClick={()=>edit(test)}>  ویرایش </Button>
            <Button className="w-full mt-1 rounded-lg" variant="contained" color="error" onClick={()=>removeTest(test)}> حذف آزمون </Button>
        </div>
    </div>
  )
}
